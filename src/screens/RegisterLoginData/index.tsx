...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    try {
      ...
      const savedPasswords: FormData[] = response ? JSON.parse(response) : []
      savedPasswords.push(newLoginData)
      
      await AsyncStorage.setItem(dataKey, JSON.stringify(savedPasswords))
